...
fun listSulogFiles(): List<SulogFile> {
    val fileNames = listOf(
        "sulog-2026-06-17.log",
        "sulog-2026-06-16-1.log",
        "sulog-2026-06-15.log"
    )
...
fun readSulogFile(path: String): List<String> {
    return listOf(
        """seq=1001 type=daemon_start ts_ns=2000000000 pid=1000 uid=0 message="UI template daemon log; no daemon was started"""",
        """seq=1002 type=sucompat ts_ns=4000000000 uid=10xxx pid=2301 package="app.example.terminal" profile="default-template" result=allow""",
        """seq=1003 type=root_execve ts_ns=6000000000 uid=10xxx pid=2302 package="app.example.toolbox" argv="<redacted>" result=allow""",
        """seq=1004 type=ioctl_grant_root ts_ns=8000000000 uid=10xxx pid=2303 package="app.example.wallet" result=deny reason="template policy"""",
        """seq=1005 type=dropped ts_ns=10000000000 count=3 reason="template rate limit""""
    )
}
