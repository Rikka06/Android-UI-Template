...
import com.template.app.ui.component.choosekmidialog.ChooseKmiDialog
...
import com.template.app.ui.kernelFlash.rememberAnyKernel3State
...
import com.template.app.ui.util.getAvailablePartitions
import com.template.app.ui.util.getCurrentKmi
import com.template.app.ui.util.getDefaultPartition
import com.template.app.ui.util.getSlotSuffix
import com.template.app.ui.util.isAbDevice
import android.net.Uri
import androidx.compose.material3.SnackbarHostState
import androidx.compose.runtime.rememberCoroutineScope
import androidx.compose.ui.platform.LocalResources
import com.template.app.ui.util.*
    ...
    val selectImageLauncher = rememberLauncherForActivityResult(
        ...
        if (it.resultCode == Activity.RESULT_OK) {
            it.data?.data?.let { uri ->
                ...
                option?.let { opt ->
                    installMethod = opt
                    // 瀵逛簬 HorizonKernel锛岄渶瑕佽Е鍙?AnyKernel3 娴佺▼锛堟Ы浣嶉€夋嫨鍜孠PM淇ˉ锛?
