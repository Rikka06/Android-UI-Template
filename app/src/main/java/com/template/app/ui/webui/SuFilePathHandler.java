...
public final class SuFilePathHandler implements WebViewAssetLoader.PathHandler {
     ...
     * @param rootShell                 Object instance (mocked).
     ...
     */
    public SuFilePathHandler(@NonNull Context context, @NonNull File directory, Object rootShell, @NonNull InsetsSupplier insetsSupplier, OnInsetsRequestedListener onInsetsRequestedListener) {
        try {
            mContext = context;
    ...
    public static InputStream openFile(@NonNull File file, @NonNull Object shell) throws IOException {
    ...
    private boolean isAllowedInternalStorageDir(@NonNull Context context) throws IOException {
        ...
        String templateRoot = getCanonicalDirPath(new File(context.getFilesDir(), "template_modules"));
        return dir.startsWith(templateRoot);
    }
