...
class DownloadService : Service() {
    ...
    companion object {
        ...
        const val ACTION_DOWNLOAD = "com.template.app.action.DOWNLOAD"
        const val ACTION_CANCEL = "com.template.app.action.CANCEL_DOWNLOAD"
        const val ACTION_DISMISS_DOWNLOAD = "com.template.app.action.DISMISS_DOWNLOAD"
        const val ACTION_INSTALL_MODULE = "com.template.app.action.INSTALL_MODULE"
    ...
    private fun startDownload(id: Int, url: String, fileName: String) {
        val job = serviceScope.launch {
            ...
            try {
                // UI Template: simulate downloading locally
                ...
                // Write a dummy file to avoid IO exception later if someone reads it
                FileOutputStream(target).use { fos ->
                    fos.write("UI Template: Mock downloaded file data.".toByteArray())
                }
