 ...
 *
 * Timeline:
 * - During animation: returns false 鈫?page shows lightweight placeholder (smooth animation)
 * - Animation ends + 1 frame: returns true 鈫?heavy content composes
 *   (stutter is invisible because the page is already static)
 *
 * The value is sticky 鈥?once true it never reverts to false,
